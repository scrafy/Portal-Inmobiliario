...
class JsonMapper {
     ...
     */
    public $arInspectedClasses = array();
     ...
     * @return void
     */
    public function checkMissingData($providedProperties, ReflectionClass $rc) {
     ...
     */
    public function inspectProperty(ReflectionClass $rc, $name) {
     ...
     */
    public function isObjectOfSameType($type, $value) {
     ...
     */
    public function isNullable($type) {
     ...
     */
    public function removeNullable($type) {
        if ($type === null) {
            return null;
        }
        return substr(
