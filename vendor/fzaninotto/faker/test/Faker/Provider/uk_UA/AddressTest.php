...
class AddressTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testStreetCyrOnly() {
        ...
        $this->assertSame(
                preg_match($pattern, $streetName), 1, 'Street name ' . $streetName . ' is wrong!'
        );
    }
    ...
    public function testCityNameCyrOnly() {
        ...
        $this->assertSame(
                preg_match($pattern, $city), 1, 'City name ' . $city . ' is wrong!'
        );
    }
    ...
    public function testRegionNameCyrOnly() {
        ...
        $this->assertSame(
                preg_match($pattern, $regionName), 1, 'Region name ' . $regionName . ' is wrong!'
        );
    }
    ...
    public function testCountryCyrOnly() {
        ...
        $this->assertSame(
                preg_match($pattern, $country), 1, 'Country name ' . $country . ' is wrong!'
        );
    }
