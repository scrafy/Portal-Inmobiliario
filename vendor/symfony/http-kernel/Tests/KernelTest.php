...
EOF;
    ...
    public function testLocateResourceReturnsAllMatches() {
        ...
        $this->assertEquals(array(
            ...
            __DIR__ . '/Fixtures/Bundle1Bundle/foo.txt',), $kernel->locateResource('@Bundle1Bundle/foo.txt', null, false));
    }
    ...
    public function testLocateResourceReturnsAllMatchesBis() {
        ...
        $this->assertEquals(
                array(__DIR__ . '/Fixtures/Bundle1Bundle/foo.txt'), $kernel->locateResource('@Bundle1Bundle/foo.txt', null, false)
        );
    }
    ...
    public function testLocateResourceIgnoresDirOnNonResource() {
        ...
        $this->assertEquals(
                __DIR__ . '/Fixtures/Bundle1Bundle/foo.txt', $kernel->locateResource('@Bundle1Bundle/foo.txt', __DIR__ . '/Fixtures')
        );
    }
    ...
    public function testLocateResourceReturnsTheDirOneForResources() {
        ...
        $this->assertEquals(
                __DIR__ . '/Fixtures/Resources/FooBundle/foo.txt', $kernel->locateResource('@FooBundle/Resources/foo.txt', __DIR__ . '/Fixtures/Resources')
        );
    }
    ...
    public function testLocateResourceReturnsTheDirOneForResourcesAndBundleOnes() {
        ...
        $this->assertEquals(array(
            ...
            __DIR__ . '/Fixtures/Bundle1Bundle/Resources/foo.txt',), $kernel->locateResource('@Bundle1Bundle/Resources/foo.txt', __DIR__ . '/Fixtures/Resources', false)
        );
    }
    ...
    public function testLocateResourceOverrideBundleAndResourcesFolders() {
        ...
        $this->assertEquals(
                __DIR__ . '/Fixtures/Resources/ChildBundle/foo.txt', $kernel->locateResource('@BaseBundle/Resources/foo.txt', __DIR__ . '/Fixtures/Resources')
        );
    ...
    public function testLocateResourceOnDirectories() {
        ...
        $this->assertEquals(
                __DIR__ . '/Fixtures/Resources/FooBundle/', $kernel->locateResource('@FooBundle/Resources/', __DIR__ . '/Fixtures/Resources')
        );
        $this->assertEquals(
                __DIR__ . '/Fixtures/Resources/FooBundle', $kernel->locateResource('@FooBundle/Resources', __DIR__ . '/Fixtures/Resources')
        );
        ...
        $this->assertEquals(
                __DIR__ . '/Fixtures/Bundle1Bundle/Resources/', $kernel->locateResource('@Bundle1Bundle/Resources/')
        );
        $this->assertEquals(
                __DIR__ . '/Fixtures/Bundle1Bundle/Resources', $kernel->locateResource('@Bundle1Bundle/Resources')
        );
