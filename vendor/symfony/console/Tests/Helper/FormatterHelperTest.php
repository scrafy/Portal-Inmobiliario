...
class FormatterHelperTest extends TestCase {
    ...
    public function testFormatSection() {
        ...
        $this->assertEquals(
                '<info>[cli]</info> Some text to display', $formatter->formatSection('cli', 'Some text to display'), '::formatSection() formats a message in a section'
        );
    }
    ...
    public function testFormatBlock() {
        ...
        $this->assertEquals(
                '<error> Some text to display </error>', $formatter->formatBlock('Some text to display', 'error'), '::formatBlock() formats a message in a block'
        );
