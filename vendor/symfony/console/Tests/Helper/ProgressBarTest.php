...
class ProgressBarTest extends TestCase {
    ...
    public function testMultipleStart() {
        ...
        $this->assertEquals(
                ...
                $this->generateOutput('    0 [>---------------------------]'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testAdvance() {
        ...
        $this->assertEquals(
                '    0 [>---------------------------]' .
                $this->generateOutput('    1 [->--------------------------]'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testAdvanceOverMax() {
        ...
        $this->assertEquals(
                ...
                $this->generateOutput(' 11/11 [============================] 100%'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testRegressWithStep() {
        ...
        $this->assertEquals(
                ...
                $this->generateOutput('    6 [------>---------------------]'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testRegressMultipleTimes() {
        ...
        $this->assertEquals(
                ...
                $this->generateOutput('    3 [--->------------------------]'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testRegressBelowMin() {
        ...
        $this->assertEquals(
                '  1/10 [==>-------------------------]  10%' .
                $this->generateOutput('  0/10 [>---------------------------]   0%'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testCustomizations() {
        ...
        $this->assertEquals(
                '  0/10 [/         ]   0%' .
                $this->generateOutput('  1/10 [_/        ]  10%'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testDisplayWithoutStart() {
        ...
        rewind($output->getStream());
        $this->assertEquals(
                '  0/50 [>---------------------------]   0%', stream_get_contents($output->getStream())
        );
    }
    ...
    public function testFinishWithoutStart() {
        ...
        rewind($output->getStream());
        $this->assertEquals(
                ' 50/50 [============================] 100%', stream_get_contents($output->getStream())
        );
    }
    ...
    public function testStartWithMax() {
        ...
        $this->assertEquals(
                ' 0/50 [>---------------------------]' .
                $this->generateOutput(' 1/50 [>---------------------------]'), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testClear() {
        ...
        $this->assertEquals(
                ...
                $this->generateOutput(''), stream_get_contents($output->getStream())
        );
    }
    ...
    public function testSetFormat() {
        ...
        rewind($output->getStream());
        $this->assertEquals(
                '    0 [>---------------------------]', stream_get_contents($output->getStream())
        );
        ...
        rewind($output->getStream());
        $this->assertEquals(
                '  0/10 [>---------------------------]   0%', stream_get_contents($output->getStream())
        );
    }
