...
class DoublerSpec extends ObjectBehavior {
    ...
    ClassPatchInterface $alt1, ClassPatchInterface $alt2, ClassPatchInterface $alt3, ClassPatchInterface $alt4
    ) {
    ...
    $mirror, $creator, $namer, ClassPatchInterface $alt1, ClassPatchInterface $alt2, \ReflectionClass $class, \ReflectionClass $interface1, \ReflectionClass $interface2, ClassNode $node
    ) {
    ...
    $mirror, \ReflectionClass $class, ClassNode $node, $namer
    ) {
