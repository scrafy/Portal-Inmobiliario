...
class ObjectProphecySpec extends ObjectBehavior {
    ...
    MethodProphecy $method1, MethodProphecy $method2, ArgumentsWildcard $arguments
    ) {
    ...
    $lazyDouble, CallCenter $callCenter, RevealerInterface $revealer
    ) {
    ...
    $lazyDouble, CallCenter $callCenter, ArgumentsWildcard $wildcard, Call $call
    ) {
        $this->beConstructedWith($lazyDouble, $callCenter);
    ...
    MethodProphecy $methodProphecy, ArgumentsWildcard $argumentsWildcard
    ) {
    ...
    MethodProphecy $methodProphecy1, MethodProphecy $methodProphecy2, ArgumentsWildcard $argumentsWildcard1, ArgumentsWildcard $argumentsWildcard2
    ) {
    ...
    Doubler $doubler, ProphecySubjectInterface $reflection
    ) {
