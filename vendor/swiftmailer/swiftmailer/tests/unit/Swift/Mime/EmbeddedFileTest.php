...
class Swift_Mime_EmbeddedFileTest extends Swift_Mime_AttachmentTest {
    ...
    public function testNestingLevelIsEmbedded() {
        $file = $this->_createEmbeddedFile($this->_createHeaderSet(), $this->_createEncoder(), $this->_createCache()
        );
        $this->assertEquals(
    ...
    public function testIdIsAutoGenerated() {
        ...
        $file = $this->_createEmbeddedFile($headers, $this->_createEncoder(), $this->_createCache()
        );
    }
