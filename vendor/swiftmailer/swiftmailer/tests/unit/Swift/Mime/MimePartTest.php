...
class Swift_Mime_MimePartTest extends Swift_Mime_AbstractMimeEntityTest {
    ...
    public function testCharsetIsReturnedFromHeader() {
        ...
        $cType = $this->_createHeader('Content-Type', 'text/plain', array('charset' => 'iso-8859-1')
        );
    ...
    public function testCharsetIsSetInHeader() {
        $cType = $this->_createHeader('Content-Type', 'text/plain', array('charset' => 'iso-8859-1'), false
        );
    ...
    public function testSettingCharsetNotifiesEncoder() {
        ...
        $part = $this->_createMimePart($this->_createHeaderSet(), $encoder, $this->_createCache()
        );
        $part->setCharset('utf-8');
    }
    ...
    public function testSettingCharsetNotifiesHeaders() {
        ...
        $part = $this->_createMimePart($headers, $this->_createEncoder(), $this->_createCache()
        );
        $part->setCharset('utf-8');
    }
    ...
    public function testFormatIsReturnedFromHeader() {
        ...
        $cType = $this->_createHeader('Content-Type', 'text/plain', array('format' => 'flowed')
        );
        $part = $this->_createMimePart($this->_createHeaderSet(array(
                    'Content-Type' => $cType,)), $this->_createEncoder(), $this->_createCache()
        );
    ...
    public function testDelSpIsReturnedFromHeader() {
        ...
        $cType = $this->_createHeader('Content-Type', 'text/plain', array('delsp' => 'no')
        );
        $part = $this->_createMimePart($this->_createHeaderSet(array(
                    'Content-Type' => $cType,)), $this->_createEncoder(), $this->_createCache()
        );
