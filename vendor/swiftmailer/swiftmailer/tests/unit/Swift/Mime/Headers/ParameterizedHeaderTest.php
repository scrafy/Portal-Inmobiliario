...
class Swift_Mime_Headers_ParameterizedHeaderTest extends \SwiftMailerTestCase {
    ...
    public function testTypeIsParameterizedHeader() {
        $header = $this->_getHeader('Content-Type', $this->_getHeaderEncoder('Q', true), $this->_getParameterEncoder(true)
        );
    ...
    public function testSpaceInParamResultsInQuotedString() {
        $header = $this->_getHeader('Content-Disposition', $this->_getHeaderEncoder('Q', true), $this->_getParameterEncoder(true)
        );
    ...
    public function testEncodedParamDataIncludesCharsetAndLanguage() {
        ...
        $this->assertEquals(
                ...
                str_repeat('a', 20) . '%8F' . str_repeat('a', 10), $header->getFieldBody()
        );
    }
    ...
    public function testSetParameter() {
        ...
        $this->assertEquals(array('charset' => 'utf-8', 'delsp' => 'no'), $header->getParameters()
        );
    }
