...
class Swift_Mime_Headers_MailboxHeaderTest extends \SwiftMailerTestCase {
    ...
    public function testMailboxIsSetForAddress() {
        ...
        $this->assertEquals(array('chris@swiftmailer.org'), $header->getNameAddressStrings()
        );
    }
    ...
    public function testQuotesInNameAreQuoted() {
        ...
        $this->assertEquals(
                array('"Chris Corbyn, \"DHE\"" <chris@swiftmailer.org>'), $header->getNameAddressStrings()
        );
    }
    ...
    public function testEscapeCharsInNameAreQuoted() {
        ...
        $this->assertEquals(
                array('"Chris Corbyn, \\\\escaped\\\\" <chris@swiftmailer.org>'), $header->getNameAddressStrings()
        );
    }
    ...
    public function testMultipleAddressesCanBeSetAndFetched() {
        ...
        $this->assertEquals(
                array('chris@swiftmailer.org', 'mark@swiftmailer.org'), $header->getAddresses()
        );
    }
    ...
    public function testMultipleAddressesAsMailboxes() {
        ...
        $this->assertEquals(
                array('chris@swiftmailer.org' => null, 'mark@swiftmailer.org' => null), $header->getNameAddresses()
        );
    }
    ...
    public function testMultipleAddressesAsMailboxStrings() {
        ...
        $this->assertEquals(
                array('chris@swiftmailer.org', 'mark@swiftmailer.org'), $header->getNameAddressStrings()
        );
    }
    ...
    public function testSetAddressesOverwritesAnyMailboxes() {
        ...
        $this->assertEquals(
            ...
            'mark@swiftmailer.org' => 'Mark Corbyn',), $header->getNameAddresses()
        );
        $this->assertEquals(
                array('chris@swiftmailer.org', 'mark@swiftmailer.org'), $header->getAddresses()
        );
    ...
    public function testNameIsEncodedIfNonAscii() {
        ...
        $this->assertEquals(
                'Chris =?' . $this->_charset . '?Q?C=8Frbyn?= <chris@swiftmailer.org>', array_shift($addresses)
        );
    }
    ...
    public function testGetValueReturnsMailboxStringValueForMultipleMailboxes() {
        ...
        $this->assertEquals(
                'Chris Corbyn <chris@swiftmailer.org>, Mark Corbyn <mark@swiftmailer.org>', $header->getFieldBody()
        );
    }
    ...
    public function testRemoveAddressesWithSingleValue() {
        ...
        $this->assertEquals(array('mark@swiftmailer.org'), $header->getAddresses()
        );
    }
