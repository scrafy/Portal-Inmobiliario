...
class Swift_Plugins_RedirectingPluginTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testArrayOfRecipientsCanBeExplicitlyDefined() {
        ...
        $this->assertEquals(
                $message->getTo(), array('fabien@example.com' => 'Fabien', 'lars-to@internal.com' => 'Lars (To)', 'god@example.com' => null)
        );
        $this->assertEquals(
                $message->getCc(), array('fabien@example.com' => 'Fabien', 'lars-cc@internal.org' => 'Lars (Cc)')
        );
