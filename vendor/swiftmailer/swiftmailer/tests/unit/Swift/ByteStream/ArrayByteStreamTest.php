...
class Swift_ByteStream_ArrayByteStreamTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testReadingMultipleBytesFromBaseInput() {
        ...
        $this->assertEquals(array('ab', 'cd'), $output, '%s: Bytes read from stream should be in pairs'
        );
    }
    ...
    public function testReadingOddOffsetOnLastByte() {
        ...
        $this->assertEquals(array('ab', 'cd', 'e'), $output, '%s: Bytes read from stream should be in pairs except final read'
        );
    }
    ...
    public function testBytesCanBeWrittenToStream() {
        ...
        $this->assertEquals(array('a', 'b', 'c', 'd', 'e'), $output, '%s: Bytes read from stream should be from initial stack + written'
        );
    }
    ...
    public function testConstructorCanTakeStringArgument() {
        ...
        $this->assertEquals(array('a', 'b', 'c'), $output, '%s: Bytes read from stream should be the same as bytes in constructor'
        );
    }
