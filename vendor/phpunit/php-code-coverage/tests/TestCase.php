...
abstract class TestCase extends \PHPUnit_Framework_TestCase {
    ...
    protected function getCoverageForBankAccount() {
        ...
        $coverage->stop(
                true, [TEST_FILES_PATH . 'BankAccount.php' => range(6, 9)]
        );
        ...
        $coverage->stop(
                true, [TEST_FILES_PATH . 'BankAccount.php' => range(27, 32)]
        );
        ...
        $coverage->stop(
                true, [TEST_FILES_PATH . 'BankAccount.php' => range(20, 25)]
        );
    ...
    protected function getCoverageForFileWithIgnoredLines() {
        ...
        $coverage = new CodeCoverage(
                $this->setUpXdebugStubForFileWithIgnoredLines(), $filter
        );
    ...
    protected function getCoverageForClassWithAnonymousFunction() {
        ...
        $coverage = new CodeCoverage(
                $this->setUpXdebugStubForClassWithAnonymousFunction(), $filter
        );
