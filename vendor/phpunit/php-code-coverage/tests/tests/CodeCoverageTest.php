...
class CodeCoverageTest extends TestCase {
    ...
    public function testCanBeConstructedForXdebugWithoutGivenFilterObject() {
        ...
        $this->assertAttributeInstanceOf(
                Xdebug::class, 'driver', $this->coverage
        );

        $this->assertAttributeInstanceOf(
                Filter::class, 'filter', $this->coverage
        );
    }
    ...
    public function testCanBeConstructedForPhpdbgWithoutGivenFilterObject() {
        ...
        $this->assertAttributeInstanceOf(
                PHPDBG::class, 'driver', $this->coverage
        );
    ...
    public function testSetCheckForMissingCoversAnnotation() {
        ...
        $this->assertAttributeEquals(
                true, 'checkForMissingCoversAnnotation', $this->coverage
        );
    }
    ...
    public function testSetCheckForUnexecutedCoveredCode() {
        ...
        $this->assertAttributeEquals(
                true, 'checkForUnexecutedCoveredCode', $this->coverage
        );
    }
    ...
    public function testSetIgnoreDeprecatedCode() {
        ...
        $this->assertAttributeEquals(
                true, 'ignoreDeprecatedCode', $this->coverage
        );
    }
    ...
    public function testMerge2() {
        $coverage = new CodeCoverage(
                $this->createMock(Xdebug::class), new Filter
        );
    ...
    public function testGetLinesToBeIgnored() {
        $this->assertEquals(
            ...
            38
                        ...
                        $this->coverage, TEST_FILES_PATH . 'source_with_ignore.php'
                )
        );
    }
    ...
    public function testGetLinesToBeIgnored2() {
        $this->assertEquals(
                [1, 5], $this->getLinesToBeIgnored()->invoke(
                        $this->coverage, TEST_FILES_PATH . 'source_without_ignore.php'
                )
        );
    }
    ...
    public function testGetLinesToBeIgnored3() {
        $this->assertEquals(
            ...
            20
                        ...
                        $this->coverage, TEST_FILES_PATH . 'source_with_class_and_anonymous_function.php'
                )
        );
    }
    ...
    public function testGetLinesToBeIgnoredOneLineAnnotations() {
        $this->assertEquals(
            ...
            37
                        ...
                        $this->coverage, TEST_FILES_PATH . 'source_with_oneline_annotations.php'
                )
        );
    }
