...
class Framework_MockObjectTest extends PHPUnit_Framework_TestCase {
    ...
    public function testVerificationOfMethodNameFailsWithWrongParameters() {
        ...
        try {
            ...
            $this->assertSame(
                    ...
                    . 'Failed asserting that two arrays are equal.', $e->getMessage()
            );
        }
    ...
    public function testInterfaceWithStaticMethodCanBeStubbed() {
        $this->assertInstanceOf(
                InterfaceWithStaticMethod::class, $this->getMockBuilder(InterfaceWithStaticMethod::class)->getMock()
        );
    }
    ...
    public function testStubForClassThatImplementsSerializableCanBeCreatedWithoutInvokingTheConstructor() {
        $this->assertInstanceOf(
                ClassThatImplementsSerializable::class, $this->getMockBuilder(ClassThatImplementsSerializable::class)
                        ->disableOriginalConstructor()
                        ->getMock()
        );
    }
    ...
    public function testGetMockForClassWithSelfTypeHint() {
        $this->assertInstanceOf(
                ClassWithSelfTypeHint::class, $this->getMockBuilder(ClassWithSelfTypeHint::class)->getMock()
        );
    }
