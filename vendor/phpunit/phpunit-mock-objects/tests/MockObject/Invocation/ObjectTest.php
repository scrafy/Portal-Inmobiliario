...
class Framework_MockObject_Invocation_ObjectTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructorRequiresClassAndMethodAndParametersAndObject() {
        $this->assertInstanceOf(
                PHPUnit_Framework_MockObject_Invocation_Object::class, new PHPUnit_Framework_MockObject_Invocation_Object(
                'FooClass', 'FooMethod', ['an_argument'], 'ReturnType', new stdClass
                )
        );
    }
    ...
    public function testAllowToGetObjectSetInConstructor() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Object(
                'FooClass', 'FooMethod', ['an_argument'], 'ReturnType', $expectedObject
        );
    ...
    public function testAllowToGetMethodParametersSetInConstructor() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Object(
                'FooClass', 'FooMethod', $expectedParameters, 'ReturnType', new stdClass
        );
    ...
    public function testConstructorAllowToSetFlagCloneObjectsInParameters() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Object(
                'FooClass', 'FooMethod', $parameters, 'ReturnType', new stdClass, $cloneObjects
        );
    ...
    public function testAllowToGetReturnTypeSetInConstructor() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Object(
                'FooClass', 'FooMethod', ['an_argument'], $expectedReturnType, new stdClass
        );
