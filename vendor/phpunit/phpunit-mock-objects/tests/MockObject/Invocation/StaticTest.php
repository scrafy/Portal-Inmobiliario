...
class Framework_MockObject_Invocation_StaticTest extends PHPUnit_Framework_TestCase {
    ...
    public function testConstructorRequiresClassAndMethodAndParameters() {
        $this->assertInstanceOf(
                PHPUnit_Framework_MockObject_Invocation_Static::class, new PHPUnit_Framework_MockObject_Invocation_Static(
                'FooClass', 'FooMethod', ['an_argument'], 'ReturnType'
                )
        );
    }
    ...
    public function testAllowToGetMethodParametersSetInConstructor() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Static(
                'FooClass', 'FooMethod', $expectedParameters, 'ReturnType'
        );
    ...
    public function testConstructorAllowToSetFlagCloneObjectsInParameters() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Static(
                'FooClass', 'FooMethod', $parameters, 'ReturnType', $cloneObjects
        );
    ...
    public function testAllowToGetReturnTypeSetInConstructor() {
        ...
        $invocation = new PHPUnit_Framework_MockObject_Invocation_Static(
                'FooClass', 'FooMethod', ['an_argument'], $expectedReturnType
        );
